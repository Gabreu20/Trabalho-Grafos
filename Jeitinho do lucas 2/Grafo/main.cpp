...
int selecionar(int selecao, Graph* graph, string output)
{
    ...
    case 5:
    {
        ...
        int confirmacao;
        cout << "Arvore geradora minima de prim a partir do ponto 0(digite qualquer coisa para iniciar):";
        cin >> confirmacao;
        Graph* g;
        g = graph->agmPrim(0);
        output_file << g->Saida();
    ...
    case 6:
    {
        ...
        int confirmacao;
        cout << "Arvore geradora minima de Kruscal (digite qualquer coisa para iniciar):";
        cin >> confirmacao;
        Graph* g;
        g = graph->agmKuskal(0);
        output_file << g->Saida();
    ...
    case 8:
    {
        cout << "ordenacao topologica dos nos (digite qualquer coisa para iniciar)" << endl;
        int confirmacao;
        cin >> confirmacao;
        Graph* aux = graph;
